...
The Antagonistic Pleiotropy theory of why we age implies the Selection Shadow hypothesis. Since cells have mechanisms to turn genes on and off, the failure to turn off genes that are harmful in old age is attributed to limited evolutionary pressure to do so. The Disposable Soma theory of why we age also implies the Selection Shadow hypothesis. The lifespan of the mouse could be extended without affecting fertility, extended up until at least the lifespan of the squirrel; however, it is argued that there is negligible evolutionary incentive to do this. According to the Disposable Soma theory, once reproduction has occurred, evolutionary forces for survival of the soma weaken.
