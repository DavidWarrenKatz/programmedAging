...
**Summary**:  
The authors generated a multi-omics single cell dataset of the immune system and compared this dataset with public datasets. By analysing this new dataset, the authors found that a population of clonal Gzmk+ CD8+ T cells emerge in old mice. Gzmk was not detected in cells other that this subpopulation of CD8+ T cells. These Taa cells were characterized by co-expression of the transcription factor TOX (exhaustion) and the checkpoint molecule PD-1 and Pdcp1. This observation can not yet be confirmed by flow cytometry, but was confimed by analysis of public datasets, mice cell lines, and human samples. 
