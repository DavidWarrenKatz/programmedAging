...
<div style="display: flex; justify-content: space-between; align-items: center;">
    <div style="flex: 1; margin-right: 10px; text-align: center;">
        <img src="../../images/papers/Masopust/Figure1A.png" alt="Figure1A" style="width: 100%; max-width: 400px; height: auto;">
        <p><strong>Figure 1A</strong></p>
    </div>
    <div style="flex: 1; margin-left: 10px; text-align: center;">
        <img src="../../images/papers/Masopust/Figure1C.png" alt="Figure1C" style="width: 100%; max-width: 400px; height: auto;">
